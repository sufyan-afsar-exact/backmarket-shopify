...
function startServer(shopify) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield new backmarketService_1.BackMarketService().checkBackMarketAPI();
            yield new quantityMappingService_1.QuantityMappingService().handleShopifyInventoryUpdate();
